...
public class FoodIssues extends AppCompatActivity {

    private FirebaseDatabase database=FirebaseDatabase.getInstance();
    private DatabaseReference reference=database.getReference("Issues").child("foodIssues");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_issues);
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reference.child(rollNoOfIssueCreator).setValue(overAllIssues)
                        ...
                        {
                            Toast.makeText(FoodIssues.this,"Success",Toast.LENGTH_SHORT).show();
                        })
                        .addOnFailureListener(e->
                        {
                            Toast.makeText(FoodIssues.this,"Not Filled",Toast.LENGTH_SHORT).show();
                        });
